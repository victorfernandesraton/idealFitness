        ...
        <div class="card-deck ml-5 row justify-content-center mt-5">
            <div class="card btnLaranja col-8 col-md-4">
                <div class="card-body">
                    ...
                    <a href="#" class="no-shadow float-right card-link"><span class="btn text-light rounded bg-dark">Ver no Maps</span></a>
                </div>
            </div>
            <div class="card btnLaranja col-8 col-md-4">
                <div class="card-body">
                    <h5 class="no-shadow font-weight-bold card-title ml-5">Pituba</h5>
                    <p class="no-shadow card-text text-light">Av. Alguma coisa - Lugar Nenhum N° 300</p>
                    <a href="#" class="no-shadow float-right card-link"><span class="btn text-light rounded bg-dark">Ver no Maps</a>
                </div>
            </div>
        </div>
        <div class="card-deck ml-5 mt-5 mb-5 row">
            <div class="card btnLaranja col-8 col-sm-12">
                <div class="card-body cardsTriplo">
                    ...
                    <p class="no-shadow card-text textoTriplo text-light">Lugar Nenhum N° 300</p>
                    <a href="#" class="no-shadow float-right card-link linkTriplo"><span class="btn text-light rounded bg-dark">Ver no Maps</a>
                </div>
            </div>
            <div class="card btnLaranja col-8 col-sm-12">
                <div class="card-body cardsTriplo">
